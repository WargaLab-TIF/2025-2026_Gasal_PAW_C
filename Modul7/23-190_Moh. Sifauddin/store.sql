...
--
-- Host: localhost:3306
-- Waktu pembuatan: 19 Nov 2025 pada 03.30
-- Versi server: 8.0.30
-- Versi PHP: 8.1.10
...
CREATE TABLE `pembayaran` (
  ...
  `total` int NOT NULL,
  `metode` enum('TUNAI','TRANSFER','EDC') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
...
(1, '2025-11-08', 'Kebutuhan Kelas', 85000, 1),
(2, '2025-11-09', 'kebutuhan Pribadi', 110000, 2),
(3, '2025-11-10', 'Kebutuhan Kelas', 50000, 3),
(4, '2025-11-11', 'kebutuhan Pribadi', 94000, 4),
(5, '2025-11-12', 'Kebutuhan kelas', 72000, 5),
(6, '2025-11-11', 'Kebutuhan Kelas', 45000, 6),
(7, '2025-11-13', 'Kebutuhan Kelas', 56000, 7),
(8, '2025-11-14', 'kebutuhan Kelas', 105000, 8),
(9, '2025-11-14', 'Kebutuhan Pribadi', 5000, 9),
(10, '2025-11-17', 'Pembelian Alat Tulis', 65000, 10);
...
CREATE TABLE `user` (
  ...
  `hp` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
