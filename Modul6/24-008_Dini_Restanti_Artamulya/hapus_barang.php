...
if (isset($_GET['id'])) {
    ...
    if (mysqli_num_rows($cek) > 0) {
        echo "<script>alert('Barang ini sudah digunakan dalam transaksi, tidak dapat dihapus!');
        document.location.href='hapus_barang.php';</script>";
    } else {
...
<body>
    ...
    <table>
        ...
        <tr>
            ...
            <td><?= $b['stok'] ?></td>
            <td>
                <a href="hapus_barang.php?id=<?= $b['id'] ?>" onclick="return confirm('Apakah Anda yakin ingin menghapus barang ini?')">Hapus</a>
            </td>
        </tr>
        <?php endwhile; ?>
    </table>
