...
$transaksi = mysqli_query($conn, "SELECT t.*, p.nama AS nama_pelanggan 
    FROM transaksi t 
    JOIN pelanggan p ON t.pelanggan_id = p.id");
$detail = mysqli_query($conn, "SELECT td.transaksi_id, b.nama_barang, td.qty, td.harga 
...
<body>
    ...
    <table>
        ...
        <div class="box">
            ...
            <a href="tambah_detail.php" class="btn">Tambah Detail</a>
