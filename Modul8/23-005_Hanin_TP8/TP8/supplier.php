...
if (isset($_POST['tambah'])) {
    ...
    if (tambahSupplier($nama, $alamat, $telepon)) {
        $success_message = "Data supplier berhasil ditambahkan!";
    } else {
        $error_message = "Gagal menambahkan data supplier!";
    }
}
...
if (isset($_POST['update'])) {
    ...
    if (updateSupplier($id, $nama, $alamat, $telepon)) {
        $success_message = "Data supplier berhasil diupdate!";
    } else {
        $error_message = "Gagal mengupdate data supplier!";
    }
}
...
if (isset($_GET['hapus'])) {
    $id = $_GET['hapus'];
    if (hapusSupplier($id)) {
        $success_message = "Data supplier berhasil dihapus!";
    } else {
        $error_message = "Gagal menghapus data supplier!";
    }
}
...
if (isset($_GET['edit'])) {
    $editMode = true;
    $id_edit = $_GET['edit'];
    $dataEdit = getSupplierById($id_edit);
}
?>
<!DOCTYPE html>
<html lang="en">
...
<body>
    ...
    <div class="container mt-4">
        <h4 class="h4 bg-primary text-white py-3 ps-4 mb-0">Data Master Supplier</h4>
        ...
        <div class="card mt-3">
            <div class="card-body">
                <h5 class="card-title"><?= $editMode ? 'Edit Supplier' : 'Tambah Supplier' ?></h5>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" name="nama_supplier" id="nama_supplier" 
                                   value="<?= $editMode ? $dataEdit['nama_supplier'] : '' ?>" required>
                        </div>
                        <div class="col-md-6 mb-3">
                    ...
                    <table class="table table-hover mb-0 table-bordered">
                        ...
                        <tbody>
                            <?php if (count($dataSupplier) > 0): ?>
                                <?php foreach ($dataSupplier as $nomor => $supplier): ?>
                                <tr>
                                    <td><?= $nomor + 1 ?></td>
                                    ...
                                    <td>
                                        <div class="d-flex gap-1">
                                            <a href="?edit=<?= $supplier['id'] ?>" class="btn btn-sm btn-warning">
                                                <i class="fas fa-edit"></i> Edit
                                            </a>
                                            <a href="?hapus=<?= $supplier['id'] ?>" class="btn btn-sm btn-danger" 
